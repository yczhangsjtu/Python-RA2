...
def initMap():
  offsety = gridheight
  offsetx = 0
  images["water"] = images["ground"].subsurface(
      offsetx, offsety, gridwidth, gridheight)
  offsetx = gridwidth
  images["west"] = images["ground"].subsurface(
      offsetx, offsety, gridwidth, gridheight)
  offsetx = gridwidth*2
  images["south"] = images["ground"].subsurface(
      offsetx, offsety, gridwidth, gridheight)
  offsetx = gridwidth*3
  images["north"] = images["ground"].subsurface(
      offsetx, offsety, gridwidth, gridheight)
  offsetx = gridwidth*4
  images["east"] = images["ground"].subsurface(
      offsetx, offsety, gridwidth, gridheight)
  offsety = 0
  offsetx = 0
  images["grass"] = images["ground"].subsurface(
      offsetx, offsety, gridwidth, gridheight)
  offsetx = gridwidth
  images["northwest"] = images["ground"].subsurface(
      offsetx, offsety, gridwidth, gridheight)
  offsetx = gridwidth*2
  images["southwest"] = images["ground"].subsurface(
      offsetx, offsety, gridwidth, gridheight)
  offsetx = gridwidth*3
  images["northeast"] = images["ground"].subsurface(
      offsetx, offsety, gridwidth, gridheight)
  offsetx = gridwidth*4
  images["southeast"] = images["ground"].subsurface(
      offsetx, offsety, gridwidth, gridheight)
...
class Map(SpriteContainer):
  ...
  def setBitmap(self, col, row):
    ...
    if k == 1:
      ...
      pygame.draw.rect(self.minimap, GREEN,
                       pygame.Rect(col*minimapw/self.width,
                                   row*minimaph/self.height, 1, 1),
                       1)
  ...
  def inarea(self, x, y):
    ...
    return (realx > -gridwidth and realx < battlewidth and
            realy > -gridheight and realy < battleheight)
  ...
  def fitOffset(self):
    ...
    if self.y > 0:
      self.sety(0)
    if self.x < battlewidth-self.groundwidth+50:
      self.setx(battlewidth-self.groundwidth+50)
    if self.y < battleheight-self.groundheight+50:
      self.sety(battleheight-self.groundheight+50)
