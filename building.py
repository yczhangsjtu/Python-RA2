...
def initBuildingAnimations():
  ...
  global gpileAnimation, grefnAnimation, gyardAnimation, gweapAnimation
...
class Building(Unit):
  ...
  def __drawBuildingBloodBar(self, screen, mng, offsetx, offsety):
    ...
    if self.HP >= self.fullHP/2:
      ...
      screen.blit(pygame.transform.rotate(blood, rotate),
...
class PowerAnimation(AnimationSet):
  def __init__(self):
    ...
    self.addAnimationFromSpriteSheet(
        image, x, y, width, height, m, n, offsetx, offsety, playeroffset,
        "build", False)
    x, y, m, n = 0, 0, 8, 1
    self.addAnimationFromSpriteSheet(
        image, x, y, width, height,
        m, n, offsetx, offsety, playeroffset, "normal",
        True, None, "build")
    x, y, m, n = 1704, 0, 8, 1
    self.addAnimationFromSpriteSheet(
        image, x, y, width, height,
        m, n, offsetx, offsety, playeroffset, "destroy")
...
class GrefnAnimation(AnimationSet):
  def __init__(self):
    ...
    self.addAnimationFromSpriteSheet(
        ...
        playeroffset, "build", False)
    x, y, m, n = 0, 0, 1, 1
    self.addAnimationFromSpriteSheet(
        image, x, y, width, height, m, n, offsetx, offsety,
        playeroffset, "normal", True, None, "build")
    x, y, m, n = 315, 0, 1, 1
    self.addAnimationFromSpriteSheet(
        image, x, y, width, height, m, n, offsetx, offsety,
        playeroffset, "destroy")
...
class GyardAnimation(AnimationSet):
  def __init__(self):
    ...
    self.addAnimationFromSpriteSheet(
        image, x, y, width, height, m, n, offsetx, offsety,
        playeroffset, "normalbigrepair")
    x, y, m, n = 0, 1380, 21, 2
    self.addAnimationFromSpriteSheet(
        image, x, y, width, height, m, n, offsetx, offsety,
        playeroffset, "destroybigrepair")
    x, y, m, n = 0, 2070, 18, 1
    self.addAnimationFromSpriteSheet(
        image, x, y, width, height, m, n, offsetx, offsety,
        playeroffset, "normalsmallrepair")
    x, y, m, n = 0, 2415, 18, 1
    self.addAnimationFromSpriteSheet(
        image, x, y, width, height, m, n, offsetx, offsety,
        playeroffset, "destroysmallrepair")
  ...
  def __init__(self):
    ...
    for player in range(numofplayer):
      ...
      animation.addBrokenSpriteSheet(
          image, x, y, i0, j0, width, height, left, right, count,
          offsetx, offsety)
