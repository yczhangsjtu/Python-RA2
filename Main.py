...
from panels import SelectMapPanel, MapEditor, GameController, \
    GameBackController, MapBackController, StartMenu
...
def gameInit():
  global ctrlLayer, characterLayer, mapLayer, startMenu, selectMapPanel, \
      editMapPanel, mapEditor, gameController, gameBackController, \
      mapBackController, saveMapPanel
...
def startNewGame():
  ...
  loader.load(images["loadmap"], screen, mapLayer.load,
              [images["bar"].subsurface(0, 0, barlength, barheight),
               (barx, bary)])
